...
const Contact = () => {
    ...
    return (
        <div className='row g-3'>
            ...
            <Formik
            initialValues={{ name: '', email: '', subject: '', content: '', select:'' }}
            ...
            {(formik, isSubmitting) => (
                ...
                <Form className='contactUs' >
                    ...
                    <div className="form-group">
                        ...
                        <Field name="subject" className={(formik.touched.subject && formik.errors.subject) ? 'form-control is-invalid' : 'form-control'} type="date" />
                        {formik.touched.subject && formik.errors.subject ? (
                            <div className="invalid-feedback">{formik.errors.subject}</div>
                        ) : null}
                    </div>
                    ...
                    <div class="form-group">
                        <input type="file" class="form-control" id="inputGroupFile02"  onChange={onImageChange} fullWidth name="image"/>
                    </div>
                    {
                    image && <img src={URL.createObjectURL(image)} className="previewImg" alt="preview" />
                    } 
